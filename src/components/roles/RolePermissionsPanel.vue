  ...
  <Card class="min-h-0" size="sm">
          ...
          >
            ...
            <div class="grid gap-2 sm:grid-cols-2 2xl:grid-cols-4">
              ...
              >
                ...
                />
                <FieldLabel class="pointer-events-none capitalize">{{ formatLabel(action) }}</FieldLabel>
              </Field>
            </div>
          </FieldSet>
        </FieldGroup>
    ...
    <CardFooter class="flex flex-wrap items-center justify-between gap-2 border-t px-3 py-3">
      <div class="text-xs text-muted-foreground">
        {{ canUpdate ? "Changes are applied only after saving." : "You need update permission to edit this role." }}
      </div>
      <div class="flex flex-wrap justify-end gap-2">
        <Button
          variant="outline"
